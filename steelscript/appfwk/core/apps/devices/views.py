...
from steelscript.appfwk.core.apps.devices.forms import DeviceListForm, DeviceDetailForm
from steelscript.appfwk.core.apps.devices.models import Device
from steelscript.appfwk.core.apps.devices.serializers import DeviceSerializer

...
atable.add_column('timestamp', 'Timestamp', datatype='time', iskey=True, sortasc=True)
...
report.add_widget(yui3.TimeSeriesWidget, attable, 'App Framework Alerts Over Time', width=122)
...
report.add_widget(yui3.PieWidget, agtable, 'App Framework Alert Levels Pie', width=6)
report.add_widget(yui3.BarWidget, agtable, 'App Framework Alert Levels Bar', width=6)

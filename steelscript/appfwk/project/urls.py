...
urlpatterns = patterns(
    '',
    (r'^favicon\.ico$',
     lambda x: HttpResponseRedirect('/static/images/favicon.ico')),
    ...
    url(r'^pcapmgr/', include(
        'steelscript.appfwk.apps.pcapmgr.urls')),
    url(r'^data/', include('steelscript.appfwk.apps.datasource.urls')),
    url(r'^alerting/',
        include('steelscript.appfwk.apps.alerting.urls')),
    url(r'^geolocation/',
        include('steelscript.appfwk.apps.geolocation.urls')),
    url(r'^help/', include('steelscript.appfwk.apps.help.urls')),
    url(r'^preferences/',
        include('steelscript.appfwk.apps.preferences.urls')),

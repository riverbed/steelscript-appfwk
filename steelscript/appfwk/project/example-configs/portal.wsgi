...
os.environ['HOME'] = '/steelscript/wsgi'   # set home directory for wsgi process


# If running under a virtualenv, update these paths, otherwise change to empty
# strings or None
VIRTUALENV_BIN = '/steelscript/virtualenv/bin'
VIRTUALENV_SITE_PACKAGES = '/steelscript/virtualenv/lib/python2.6/site-packages'
